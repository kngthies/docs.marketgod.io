...
>
> * _For lower TFs \(IE Intraday\), keep the filter set between .5-5_ 
> * _Mid-TFs \(4H,6H,12H,1D\), the recommended range is between 5.5-10_ 
...
{% embed url="https://www.youtube.com/watch?v=eAaaiRVEcyw&t=4s" caption="Here we evaluate and differentiate the differences between strategies and studies on tradingview.com" %}
...
MarketGod For [Tradingview](https://marketgodx.com/tradingview) One Time Payment
...
**Please allow up to 8 hours for your order to be processed.** [**Tradingview**](https://marketgodx.com/tradingview) **does not allow automation on their permissions lists and we are limited to only using manual add/remove. Weekends and holidays may be slower.**

If you are not on the tool after 12 hours, please email us a reminder at admin@marketgod.io
